...
const MedicalCampSection = () => {
  return (
    <section className="relative z-10 min-h-screen md:h-[80vh] bg-gradient-to-br from-green-50 to-lime-100 flex items-center justify-center p-6 md:p-12 lg:p-24">
      <div className="max-w-6xl mx-auto text-center space-y-8">
        <h2 className="text-4xl md:text-4xl font-extrabold text-green-900 leading-tight drop-shadow-xl">
          ...
          <span className="text-lime-600">Like Never Before</span>
        </h2>
        ...
        <div className="pt-6">
          <p className="text-green-900 text-base md:text-lg font-semibold">
            Over <span className="text-lime-600 font-bold">50,000+</span>{" "}
